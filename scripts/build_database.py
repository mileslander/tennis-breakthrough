...
if __name__ == '__main__':
    run_full_etl('tennis_atp/atp_matches_qual_chall_2011.csv')
    run_full_etl('tennis_atp/atp_matches_qual_chall_2012.csv')
    run_full_etl('tennis_atp/atp_matches_qual_chall_2013.csv')
    run_full_etl('tennis_atp/atp_matches_qual_chall_2014.csv')
    run_full_etl('tennis_atp/atp_matches_qual_chall_2015.csv')
    run_full_etl('tennis_atp/atp_matches_qual_chall_2016.csv')
    run_full_etl('tennis_atp/atp_matches_qual_chall_2017.csv')
    run_full_etl('tennis_atp/atp_matches_futures_2011.csv')
    run_full_etl('tennis_atp/atp_matches_futures_2012.csv')
    run_full_etl('tennis_atp/atp_matches_futures_2013.csv')
    run_full_etl('tennis_atp/atp_matches_futures_2014.csv')
    run_full_etl('tennis_atp/atp_matches_futures_2015.csv')
    run_full_etl('tennis_atp/atp_matches_futures_2016.csv')
    run_full_etl('tennis_atp/atp_matches_futures_2017.csv')
    run_full_etl('tennis_atp/atp_matches_2011.csv') 
    run_full_etl('tennis_atp/atp_matches_2012.csv') 
    run_full_etl('tennis_atp/atp_matches_2013.csv') 
    run_full_etl('tennis_atp/atp_matches_2014.csv') 
    run_full_etl('tennis_atp/atp_matches_2015.csv') 
    run_full_etl('tennis_atp/atp_matches_2016.csv') 
    run_full_etl('tennis_atp/atp_matches_2017.csv') 
